 ...
 * @author Miki
 */
@WebServlet(name = "EditarTerminalServlet", urlPatterns = {"/EditarTerminalServlet"})
public class EditarTerminalServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       /* char t;
        ...
        Terminal terminal = facade.findById(request.getParameter("id"));
